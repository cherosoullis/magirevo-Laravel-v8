...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          <a class="navbar-brand" href="{{ route('recipes.index') }}">{{ config('app.name') }}</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                  <li class="nav-item">
                      <a class="nav-link" href="{{ route('/') }}">Αρχική</a>
                  </li>

                  <li class="nav-item active">
                      <a class="nav-link" href="{{ route('categories.index') }}">Κατηγορίες <span class="sr-only">(current)</span></a>
                  </li>
              </ul>
              ...
              <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item">
                        <a href="{{ route('recipe.create') }}" class="btn btn-success my-2 my-sm-0">Καταχώρηση Συνταγής</a>
                    </li>
      ...
      @if (Session::has('success'))
        ...
        @if (Session::has('errors'))
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <h4 class="alert-heading">Λάθος!</h4>
                <p>
                    <ul>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Τροποποίηση Κατηγορίας</h5>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{ route('categories.store') }}" method="POST">
                    ...
                    <div class="form-group">
                      <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="Όνομα Κατηγορίας" required>
                    </div>
