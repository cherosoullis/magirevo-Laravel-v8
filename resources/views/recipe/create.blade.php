  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <ul class="list-group list-group-flush">
        <li class="list-group-item">
          <div class="custom-control custom-checkbox">
            <input type="checkbox" name="christmas" class="custom-control-input" id="check17" {{ old('christmas') == 'on' ? 'checked' : '' }}>
            <label class="custom-control-label" for="check17">Χριστούγεννα</label>
          </div>
        </li>
        <li class="list-group-item">
          <div class="custom-control custom-checkbox">
            <input type="checkbox" name="easter" class="custom-control-input" id="check18" {{ old('easter') == 'on' ? 'checked' : '' }}>
            <label class="custom-control-label" for="check18">Πάσχα</label>
          </div>
        </li>
        <li class="list-group-item">
          <div class="custom-control custom-checkbox">
            <input type="checkbox" name="valendines" class="custom-control-input" id="check19" {{ old('valendines') == 'on' ? 'checked' : '' }}>
            <label class="custom-control-label" for="check19">Αγίου Βαλεντίνου</label>
          </div>
        </li>
        <li class="list-group-item">
          <div class="custom-control custom-checkbox">
            <input type="checkbox" name="fasting" class="custom-control-input" id="check20" {{ old('fasting') == 'on' ? 'checked' : '' }}>
