...
if(source){ //if the field is not there then do not execute event listener
  ...
  $('.add-execution').click(function (e) {
      ...
      $(this).closest('li').before('<li class="nav-item"><a class="nav-link" href="#execution_0'+id+'" data-toggle="tab">'+tabname+'</a><span><i class="fas fa-minus"></i></span></li>');
      $('.tab-content').append('<div class="tab-pane" id="execution_0'+id+'"><div class="tab-pane" id="execution"><input name="execution['+id+'][title]" id="exectitle" class="input-text" type="hidden" readonly value="'+tabname+'"><textarea name="execution['+id+'][body]" class="summernote'+id+'" required></textarea></div></div>');
